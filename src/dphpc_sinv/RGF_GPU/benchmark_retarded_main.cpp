...
int main() {
    ...
    */
    ...
    std::string filename = time_path + "times_retarded_fits_gpu_memory_" + std::to_string(matrix_size) + "_"   + std::to_string(n_blocks) + "_"  + std::to_string(batch_size) + "_"+ ".txt";
    ...
    filename = time_path + "times_retarded_fits_gpu_memory_with_copy_compute_overlap_" + std::to_string(matrix_size) + "_"   + std::to_string(n_blocks) + "_"  + std::to_string(batch_size) + "_"+ ".txt";
    ...
    filename = time_path + "times_retarded_does_not_fit_gpu_memory_" + std::to_string(matrix_size) + "_"   + std::to_string(n_blocks) + "_"  + std::to_string(batch_size) + "_"+ ".txt";
    ...
    filename = time_path + "times_retarded_does_not_fit_gpu_memory_with_copy_compute_overlap_" + std::to_string(matrix_size) + "_"   + std::to_string(n_blocks) + "_"  + std::to_string(batch_size) + "_"+ ".txt";
