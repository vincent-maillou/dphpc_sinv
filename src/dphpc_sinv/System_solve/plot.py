...
if __name__ == "__main__":
    warmup = 10
    times = np.loadtxt(
        "/home/sem23f28/Documents/dphpc_sinv/src/dphpc_sinv/System_solve/times.txt", dtype=np.float64)[:, warmup:]
    ...
    colors = ["blue", "cyan", "olive", "red",
              "green", "orange", "purple", "gray", "brown"]
    ...
    ax.set_title(
        "Small KMC System Solve Benchmark on Attelas \n (7165x7165, 1e-14 tolerance)")
